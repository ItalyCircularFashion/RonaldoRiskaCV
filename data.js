...
const NEWS = [
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Prato: nel 2025 il distretto tessile chiude a €3,8 miliardi di fatturato (+3,4%)',
    summary:'I dati elaborati da Confindustria Toscana Nord e Camera di Commercio di Prato mostrano un distretto in crescita: il fatturato cumulato delle aziende tessili pratesi raggiunge €3,8 miliardi nel 2025, in aumento del +3,4% rispetto al 2024. Il confronto con la media italiana del settore è positivo: l\'industria tessile nazionale cresce in media del +2,1% nello stesso periodo. Il distretto di Prato sopravanza quindi la media italiana di 1,3 punti percentuali, spinto da export Extra-UE (+6,8%), fibre rigenerate e digitalizzazione.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Exported tessile pratese: l\'Extra-UE vale il 42% del totale, Cina e USA i mercati chiave',
    summary:'Nel 2025 l\'export tessile di Prato verso i mercati Extra-UE raggiunge €1,28 miliardi, con un peso del 42% sul totale export distrettuale. Stati Uniti (+11,2%), Cina (+7,4%) e Emirati Arabi (+14,1%) guidano la crescita. A livello Italia, la quota Extra-UE media si ferma al 33%. Il dato suggerisce che Prato ha una struttura export più internazionale e meno dipendente dal mercato europeo.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Occupazione tessile Prato: +23% in 12 mesi, ma la sfida è la specializzazione digitale',
    summary:'Confindustria Toscana Nord conferma: gli occupati nel tessile pratese salgono da 12.400 a 15.250 unità tra giugno 2024 e giugno 2025 (+23,1%). Il confronto con l\'Italia è netto: l\'occupazione tessile nazionale cresce solo del +3,8% nello stesso periodo. Il driver principale è la richiesta di operatori su macchine a controllo numerico e sistemi AI-assisted. Il dato critico: il 41% delle vacancy rimane scoperta per mancanza di competenze digitali.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Fatturato medio per azienda: Prato €1,2M vs media Italia €780K, ma il gap si riduce',
    summary:'Il fatturato medio per impresa tessile nel distretto di Prato è stimato in €1,2 milioni nel 2025, contro una media italiana di €780K. Il distretto mantiene quindi un vantaggio del +53%. Tuttavia il gap si riduce: nel 2022 il divario era del +68%. Il motivo? La media Italia cresce più velocemente grazie a un reshoring diffuso e a investimenti in automazione. Per Prato il segnale è chiaro: difendere il vantaggio richiede innovazione continua.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Produttività tessile: Prato a €62K per addetto, sopra la media italiana di €54K',
    summary:'La produttività calcolata come fatturato per addetto nel 2025 posiziona Prato a €62.000, contro una media italiana di €54.000. Il dato emerge dall\'elaborazione dei bilanci di 27 aziende campione del distretto. I driver: mix produttivo più orientato al medio-alto, maggiore incidenza del finissaggio a valore aggiunto, adozione più rapida di tecnologie di controllo qualità. La media UE si ferma a €58K, quindi Prato è sopra anche il benchmark europeo.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Investimenti in sostenibilità: le aziende pratesi spendono il 4,2% del fatturato, sopra la media italiana del 2,8%',
    summary:'Un\'indagine condotta da Confindustria Toscana Nord su 42 aziende del distretto rileva che gli investimenti in sostenibilità ambientale rappresentano il 4,2% del fatturato nel 2025. La media italiana del settore è del 2,8%. Il dato riflette l\'adesione massiccia a programmi come Detox e GOTS. Il 62% delle aziende pratesi ha certificazioni ambientali attive, contro il 38% della media Italia. Il messaggio: Prato è già un distretto green-conscious, non solo dichiarato.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Demografia imprenditoriale: 31 nuove aperture e 18 cessazioni nel 2025, saldo positivo',
    summary:'Il bilancio 2025 del tessile pratese mostra 31 nuove aperture di impresa e 18 cessazioni, con un saldo positivo di +13 unità. Il confronto con l\'Italia è sfavorevole: il settore nazionale chiude il 2025 con un saldo negativo di -87 imprese. I nuovi ingressi a Prato sono soprattutto nel segmento delle fibre rigenerate e del riciclo chimico, mentre le cessazioni riguardano principalmente tintorie obsolete non adeguate a ZDHC.',
  ...
  },
  {
    ...
    cat:'econ', catLabel:'Economia Locale',
    title:'Prezzo dei capi finiti Prato: aumento medio del +5,2% nel 2025, trainato da energia e chimica',
    summary:'L\'indice dei prezzi alla produzione per i capi finiti del distretto di Prato registra un aumento medio del +5,2% nel 2025. La voce che pesa di più è l\'energia elettrica (+18,4%), seguita da prodotti chimici per tintoria (+12,1%). A livello nazionale l\'aumento è del +4,7%, quindi Prato risente leggermente di più degli shock energetici per la maggiore incidenza dei processi di finissaggio. Il dato positivo: i margini lordi si mantengono stabili al 18,5% grazie a contratti pluriennali con brand luxury.',
